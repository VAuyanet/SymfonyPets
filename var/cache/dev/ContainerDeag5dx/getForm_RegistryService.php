...
}, 'pets\\WebBundle\\Form\\LoginType' => function () {
    return ${($_ = isset($this->services['pets\WebBundle\Form\LoginType']) ? $this->services['pets\WebBundle\Form\LoginType'] : $this->services['pets\WebBundle\Form\LoginType'] = new \pets\WebBundle\Form\LoginType()) && false ?: '_'};
}, 'pets\\WebBundle\\Form\\SubtasquesType' => function () {
    return ${($_ = isset($this->services['pets\WebBundle\Form\SubtasquesType']) ? $this->services['pets\WebBundle\Form\SubtasquesType'] : $this->services['pets\WebBundle\Form\SubtasquesType'] = new \pets\WebBundle\Form\SubtasquesType()) && false ?: '_'};
}, 'pets\\WebBundle\\Form\\TasquesType' => function () {
    return ${($_ = isset($this->services['pets\WebBundle\Form\TasquesType']) ? $this->services['pets\WebBundle\Form\TasquesType'] : $this->services['pets\WebBundle\Form\TasquesType'] = new \pets\WebBundle\Form\TasquesType()) && false ?: '_'};
}, 'pets\\WebBundle\\Form\\UsuarisType' => function () {
    return ${($_ = isset($this->services['pets\WebBundle\Form\UsuarisType']) ? $this->services['pets\WebBundle\Form\UsuarisType'] : $this->services['pets\WebBundle\Form\UsuarisType'] = new \pets\WebBundle\Form\UsuarisType()) && false ?: '_'};
